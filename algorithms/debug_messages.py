# Debug message templates for bitcoin puzzle solver
debug_messages = {
...
with open("known_solutions.txt") as f:
    lines = f.readlines()
    assert lines[3].startswith("1: 0x1 (1)"), "First entry mismatch"
    assert lines[-1].startswith("66:"), "Last entry missing" 