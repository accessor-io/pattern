"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 22:03:15
    ...
    def _apply_bit_permutation(self, value, position):
        ...
        if position < 67:
            ...
            if position < 71:
                ...
                chunk1 = (base >> (16 + shift * 2)) & 0x3fff
                chunk2 = base & ((1 << (16 + shift * 2)) - 1)
                # Apply the transformation
                new_value = (chunk1 << (shift * 2 + 2)) | chunk2
