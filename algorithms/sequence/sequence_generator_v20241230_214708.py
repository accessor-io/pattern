"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 21:47:08
    ...
    def _apply_bit_permutation(self, value, position):
        ...
        if position < 67:
            if position < 20:
                ...
                preserved = base & 0xfff
                new_value = (base << 1) | (preserved & 0xff)
                new_value += position * 0x123
            elif position < 40:
                ...
                growth = (position - 40) * 0x1000
                new_value = base + growth
                new_value |= preserved
            else:
                # Final approach to position 67
                preserved = base & 0xffffff
                growth = (67 - position) * 0x10000
                new_value = base + growth
