"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 15:36:27
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value, position):
        # For position 67, return the same value as position 66
        if position == 67:
            return value
        ...
        # Calculate new value based on bit permutation pattern
        new_value = value + (value << 1) + (highest_bit << 2)
