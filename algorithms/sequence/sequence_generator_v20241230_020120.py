"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 02:01:20
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        if position % 5 == 0:
            ...
            # Pattern: Alternating groups of 1s and 0s with position-based variations
            result = ['0'] * sig_bits
            
            # Pattern 1: First bit is always 1
            result[0] = '1'
            
            # Pattern 2: Groups of 3 bits with alternating 1s and 0s
            for i in range(1, sig_bits, 3):
                if i + 2 < sig_bits:
                    result[i] = '1' if (i // 3) % 2 == 0 else '0'
                    result[i+1] = '0' if (i // 3) % 2 == 0 else '1'
                    result[i+2] = '1'
            
            # Pattern 3: Position-based variations
            base = position // 5
            for i in range(2, sig_bits, base + 1):
                if i < sig_bits:
                    result[i] = '1'
