"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 02:07:12
        ...
        if position % 5 == 0:
            ...
            for i in range(0, sig_bits, 5):
                if i < sig_bits:
                    ...
                    if len(group) > 2:
                        group[2] = '1' if (position + i) % 3 == 0 else '0'  # Middle bit based on position
                    if len(group) > 4:
                        group[4] = '1' if (position + i) % 2 == 0 else '0'  # Last bit based on position
