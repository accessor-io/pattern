"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 01:57:18
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        # For other positions, use position-based pattern
        result = ['0'] * sig_bits
        
        # For positions > 12, use a pattern based on the previous values
        if position > 12:
            ...
            # Add some position-based variations
