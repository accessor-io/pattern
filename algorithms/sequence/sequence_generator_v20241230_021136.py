"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 02:11:36
            ...
            if i < sig_bits:
                if block_pos == 0:
                    ...
                    if i % 5 == 0:
                        ...
                        result[i] = '1' if (block_num + i) % 3 == 0 else '0'
                else:
                    ...
                    if i % 5 == block_pos:
                        ...
                        result[i] = '1' if ((block_num + i) * block_pos) % 5 == 0 else '0'
        ...
        for i in range(block_pos, sig_bits - 4, 5):
            if i + 4 < sig_bits:
                ...
                if block_pos == 0:
                    ...
                    result[i+2] = '1' if ones % 5 == 0 else '0'
                    result[i+4] = '1' if ones % 3 == 0 else '0'
                else:
                    # Normal mixing for other positions
                    result[i+2] = '1' if ones % 3 == 0 else '0'
                    result[i+4] = '1' if ones % 5 == 0 else '0'
        
        # Pattern 4: Growth pattern adjustments
        if block_pos > 0:
