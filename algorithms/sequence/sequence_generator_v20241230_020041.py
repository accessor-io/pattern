"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 02:00:41
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        if position % 5 == 0:
            ...
            # Pattern: Groups of 3-4 bits with alternating 1s and 0s
            result = ['0'] * sig_bits
            
            # Pattern 1: Start with 1
            result[0] = '1'
            
            # Pattern 2: Groups of 3 bits
            ...
            # Pattern 3: Every 4th position is 1
            for i in range(3, sig_bits, 4):
                if i < sig_bits:
                    result[i] = '1'
            
            # Pattern 4: Position-based variations
            base = position // 5
            for i in range(2, sig_bits, base):
                if i < sig_bits:
                    result[i] = '1'
