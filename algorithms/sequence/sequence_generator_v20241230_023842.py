"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 02:38:42
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        if position > 85:
            ...
            result = ((value << shift_amount) | (value >> (significant_bits - shift_amount))) & mask
            return (result + pattern_base) & mask
