...
def analyze_hex_sequence(input_file, output_file):
    """
    Analyze a file containing hex strings and save analysis to output file
    Args:
        input_file: path to file containing hex strings
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        ...
        print("Example: python3 analyze_sequence.py data/32bHex.txt analysis_result.txt")
        sys.exit(1)
