"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 01:30:21
...
class SequenceGenerator:
    ...
    def generate_sequence(self, length: int) -> List[str]:
        ...
        print("\nSide by side comparison (Generated vs Original):")
        print("Position | Generated Value                                                     | Original Value")
        print("-" * 120)
        for i, (gen, orig) in enumerate(zip(hex_sequence, self.original_sequence[:length])):
            print(f"{i:8d} | {gen} | {orig}")
