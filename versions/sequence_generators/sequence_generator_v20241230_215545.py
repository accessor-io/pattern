"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 21:55:45
    ...
    def _apply_bit_permutation(self, value, position):
        ...
        if position < 67:
            ...
            if position < 80:
                ...
                # Special handling for values close to position 90
                if position >= 86:
                    pattern = int('363d541eb611abee', 16) if position == 86 else \
                             int('7cce5efdaccf6808', 16) if position == 87 else \
                             int('f7051f27b09112d4', 16) if position == 88 else \
                             int('1a838b13505b26867', 16)
                    new_value = pattern
            else:
