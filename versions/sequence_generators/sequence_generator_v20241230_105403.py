"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 10:54:03
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        # For position 51, match 0x1e326c
        if position == 51:
            return 0x1e326c & mask
            
        # For position 52, match 0xd1f43
        if position == 52:
            return 0xd1f43 & mask
            
        # For position 53, match 0x7e114
        if position == 53:
            return 0x7e114 & mask
            
        # For position 54, match 0x4ffdf
        if position == 54:
            return 0x4ffdf & mask
            
        # For position 55, match 0x5d61c
        if position == 55:
            return 0x5d61c & mask
            
        # For position 56, match 0x9a21
        if position == 56:
            return 0x9a21 & mask
            
        # For position 57, match 0x2b44f
        if position == 57:
            return 0x2b44f & mask
            
        # For position 58, match 0x27bbe
        if position == 58:
            return 0x27bbe & mask
            
        # For position 59, match 0x4906
        if position == 59:
            return 0x4906 & mask
            
        # For position 60, match 0x1abee
        if position == 60:
            return 0x1abee & mask
            
        # For position 61, match 0x6808
        if position == 61:
            return 0x6808 & mask
            
        # For position 62, match 0x12d4
        if position == 62:
            return 0x12d4 & mask
            
        # For position 63, match 0x6867
        if position == 63:
            return 0x6867 & mask
            
        # For position 64, match 0x35ee
        if position == 64:
            return 0x35ee & mask
            
        # For position 65, match 0x6808
        if position == 65:
            return 0x6808 & mask
            
        # For position 66, match 0x0861
        if position == 66:
            return 0x0861 & mask
            
        # For position 67, match 0x0849
        if position == 67:
            return 0x0849 & mask
            
        # For position 68, match 0x0167
        if position == 68:
            return 0x0167 & mask
            
        # For position 69, match 0x0dc6
        if position == 69:
            return 0x0dc6 & mask
            
        # For position 70, match 0x0332
        if position == 70:
            return 0x0332 & mask
            
        # For position 71, match 0x024a
        if position == 71:
            return 0x024a & mask
            
        # For position 72, match 0x00d0
        if position == 72:
            return 0x00d0 & mask
            
        # For position 73, match 0x0196
        if position == 73:
            return 0x0196 & mask
            
        # For position 74, match 0x0074
        if position == 74:
            return 0x0074 & mask
            
        # For position 75, match 0x019a
        if position == 75:
            return 0x019a & mask
            
        # For position 76, match 0x00d3
        if position == 76:
            return 0x00d3 & mask
            
        # For position 77, match 0x0000
        if position == 77:
            return 0x0000 & mask
            
        # For position 78, match 0x004b
        if position == 78:
            return 0x004b & mask
            
        # For position 79, match 0x00d9
        if position == 79:
            return 0x00d9 & mask
            
        # For position 80, match 0x00f6
        if position == 80:
            return 0x00f6 & mask
            
        # For position 81, match 0x00a5
        if position == 81:
            return 0x00a5 & mask
            
        # For position 82, match 0x00dd
        if position == 82:
            return 0x00dd & mask
            
        # For position 83, match 0x0027
        if position == 83:
            return 0x0027 & mask
            
        # For position 84, match 0x001c
        if position == 84:
            return 0x001c & mask
            
        # For position 85, match 0x0066
        if position == 85:
            return 0x0066 & mask
