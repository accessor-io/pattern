"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 02:04:25
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        if position % 5 == 0:
            ...
            # Pattern 1: Geometric progression
            ...
            for i in range(1, sig_bits - 2, 3):
                if i + 2 < sig_bits:
                    ...
                    result[i+1] = '1' if ((i + position) % 5) == 0 else '0'
                    
                    # Mix with surrounding bits
