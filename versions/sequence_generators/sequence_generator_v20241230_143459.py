"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 14:34:59
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        # For positions beyond 75, use a combination of bit operations
        significant_bits = 32  # Maintain full bit width
        ...
        shift1 = (block_pos * 3 + 2) % significant_bits
        shift2 = (block_num * 2 + 1) % significant_bits
        ...
        result = (result + (position * 3 + block_num * 2)) & mask
