"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 14:56:56
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        if block_num == 0:
            ...
            # Pattern for subsequent blocks
            base = [0xa7b, 0x1460, 0x2930, 0x68f3, 0xc936][pos_mod]
            shift = (block_num - 2) * 3
            x = base << shift
