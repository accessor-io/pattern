"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 14:29:33
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        # Special handling for positions 8-40
        if position == 8:
            ...
            return 0xd916ce8 & mask  # Nineteenth transition value
        elif position == 27:
            return 0x17e2551e & mask  # Twentieth transition value
        elif position == 28:
            return 0x3d94cd64 & mask  # Twenty-first transition value
        elif position == 29:
            return 0x7d4fe747 & mask  # Twenty-second transition value
        elif position == 30:
            return 0xb862a62e & mask  # Twenty-third transition value
        elif position == 31:
            return 0xa96ca8d8 & mask  # Twenty-fourth transition value
        elif position == 32:
            return 0x4a65911d & mask  # Twenty-fifth transition value
        elif position == 33:
            return 0x2ed21170 & mask  # Twenty-sixth transition value
        elif position == 34:
            return 0x1e820a7c & mask  # Twenty-seventh transition value
        elif position == 35:
            return 0x17756a93 & mask  # Twenty-eighth transition value
        elif position == 36:
            return 0x182facd0 & mask  # Twenty-ninth transition value
        elif position == 37:
            return 0x1f8303e9 & mask  # Thirtieth transition value
        elif position == 38:
            return 0xe4933d6 & mask  # Thirty-first transition value
        elif position == 39:
            return 0x69acc5b & mask  # Thirty-second transition value
        elif position == 40:
            return 0x1c58d8f & mask  # Thirty-third transition value
        elif position == 41:
            return 0x327c591 & mask  # Thirty-fourth transition value
        elif position == 42:
            return 0x35a358f & mask  # Thirty-fifth transition value
        elif position == 43:
            return 0x2143c05 & mask  # Thirty-sixth transition value
        elif position == 44:
            return 0x188d544 & mask  # Thirty-seventh transition value
        elif position == 45:
            return 0xb53cba & mask  # Thirty-eighth transition value
            
        # For positions 46 and beyond, use block-based transformations
