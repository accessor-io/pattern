"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 10:13:20
...
class SequenceGenerator:
    ...
    def _get_significant_bits(self, position: int) -> int:
        ...
        if position < 20:
            ...
            return 16 + position // 3
        elif position < 60:
            return 24 + position // 4
        else:
            return 32 + position // 5
    ...
    def _apply_bit_permutation(self, position, value):
        ...
        for i in range(num_chunks):
            ...
            if i == 0:
                ...
                # Later chunks get more mixing
                chunk ^= ((position + i) * 0x11) & chunk_mask
                chunk ^= ((transformed >> (shift - chunk_size)) & chunk_mask)
            
            # Rotate based on position and chunk index
            rotate = ((position + i) & 0x7) + 1
