"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 01:59:40
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        if position % 5 == 0:
            ...
            # For other multiples of 5, use a pattern
            # Each multiple of 5 roughly doubles the value
            base = position // 5
            result = (1 << base) | (3 << (base-1)) | (7 << (base-2))
