"""
SEQUENCE GENERATOR - Version saved at 2024-12-30 14:36:27
...
class SequenceGenerator:
    ...
    def _apply_bit_permutation(self, value: int, position: int) -> int:
        ...
        # Use full 32-bit width for all positions after initial sequence
        significant_bits = 32
        ...
        shift1 = (block_pos * 3 + block_num) % significant_bits
        shift2 = (block_num * 2 + block_pos) % significant_bits
        rotate = (position * 3 + 7) % significant_bits
        ...
        result = (result + (position * 7 + block_num * 5)) & mask
